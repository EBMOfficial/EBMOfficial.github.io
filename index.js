...
//antiphisher(client)
//settingLog(client)
// inshallah we will fix this bug (said 2 million years ago)
progress(client)
seek(client)
 ...
 // Remember, O Lord, the childrens of Edom on the day Jerusalem fell,
 // "Raze it, raze it, even to it's foundation"
 // O Daughter of Babylon, doomed to destruction, blessed is he who repays you
